...
This section is a series of case
studies of normalization and generalization, not than a complete
experimental evaluation.  These examples make it clear that
our current algorithms are practically useful, and merit further
development and optimization.  All test cases were generated using
random testing.
...
and 2 variations of the seeded fault.  Generalization only required 5 seconds.
...
normalization has contributed a surprising amount of additional

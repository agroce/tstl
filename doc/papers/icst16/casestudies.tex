...
assertion must be modified.  As far as we know, normalization
transforms all versions of this fault into a single test case, but our
data is not adequate to make this claim for certain, as the failure
rate is approximately 3 failures/100K
tests of length 100.

...
quickly converges on a normal form for many test cases.  
...
base, making the algorithm potentially nondeterministic (in theory; in
...
first in the sequential version of the algorithm remain in the work
queue.

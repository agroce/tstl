...
differently; however, determining that test case is due to the same fault
as the first test case is, we believe, likely much less difficult than
performing the same task over a set of thousands of tests with more
extreme variation.

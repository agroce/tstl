...
executing some of those tests.  Figure \ref{fig:class} shows a small portion of the
resulting Python class produced by TSTL.
...
\end{code}
\caption{Output Python code for the AVL harness (a few excerpts).}
\label{fig:class}
\end{figure}

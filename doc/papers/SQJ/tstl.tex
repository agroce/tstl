...
tests of an AVL tree class, in the latest syntax for TSTL (modified in
the course of the work described in this paper).
...
\ref{fig:avlrun} shows a
valid test case produced by running a random test generator on
...
first step of the first test case in Figure \ref{fig:avlrun} is storing a new AVL tree in {\tt
  avl1}, for example.

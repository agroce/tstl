...
a complete programming language.  The TSTL (Template Scripting Testing
...
libraries make GIS (ArcPy), numeric analysis (NumPy) or bioinformatics
(BioPython) activities simple to use in either a scripted or

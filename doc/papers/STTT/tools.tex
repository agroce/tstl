...
While TSTL is easily used as ``just another tool'' that allows testing of an SUT, TSTL can also be understood as a tool for generating custom libraries for testing.

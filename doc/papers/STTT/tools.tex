...
while (time.time() - startTime <= TIMEOUT):
   if (len(goodTests) > 0) and (rgen.random() < PEXTEND)):
     sut.backtrack(rgen.choose(goodTests)[1])
   else:
     sut.restart()

...
and records the values returned \cite{icst2014}.  For future versions of ArcPy (or
...
normalized and generalized to help users understand API usage behavior, since the set of examples
from Esri are usually limited to a small set of parameter combinations.

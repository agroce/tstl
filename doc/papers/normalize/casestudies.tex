...
{\bf RQ1:} Reduction alone did not reduce the number of failing tests at
...
Of the 13 non-singleton faults (faults with more than one
corresponding failure), normalization reduced the number of tests to
examine for 11; in 2 cases, the normalization was perfect (one failure).

...
different actions per test from 14.4 to 7.4 (median from 14.0 to 8.0).  Normalization was perfect:  one
failure per fault (2 failures), both of which had only 6 steps and 5

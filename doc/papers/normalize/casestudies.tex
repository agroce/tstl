...
{\bf RQ1 and RQ3:} Reduction did not reduce
...
$p < 1.0\times10^{-8}$.  {\bf RQ4:} Reduction took a mean of 0.11 seconds, normalization a mean of 196.8
seconds (median 0.08 vs. 177.4) (significant, $p < 1\times10^{-9}$).  There were 72 total
different actions in tests before reduction, 21 in tests after
reduction, and only 7 between the two normalized tests.

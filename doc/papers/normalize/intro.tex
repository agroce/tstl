...
without irrelevant operations\footnote{Algorithms such as
  ...
  approaches, including symbolic execution \cite{issta14} can benefit.}.  In fact, test case reduction is
...
\end{verbatim}
\mycomment{
{\bf Test case \#1}\hspace{1.2in}                                     {\bf Test case \#2}
\begin{code}
avl0 = avl.AVLTree()            int0 = 14 
int0 = 4                        avl0 = avl.AVLTree() 
int2 = 13                       int2 = 13 
int3 = 7                        int1 = 15 
avl0.insert(int2)               avl0.insert(int1) 
avl0.insert(int3)               int1 = 11 
int1 = 15                       avl0.insert(int2) 
avl0.insert(int1)               avl0.insert(int0) 
avl0.insert(int0)               avl0.insert(int1)
avl0.delete(int2)               avl0.delete(int0) 
\end{code}
{\bf Test case \#3}
\begin{code}
avl1 = avl.AVLTree() 

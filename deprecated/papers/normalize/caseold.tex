...
thoroughly investigate {\bf RQ1} and {\bf RQ2} in the context of tests
without a good fault signature.  Second, we studied
...
required an extremely long time to complete.

\subsection{Small Subjects: AVLTree and XML}
